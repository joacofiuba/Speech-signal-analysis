# espectrograma de banda angosta, visualización armonicos y frecuencia fundamental.
...
SFT = ShortTimeFFT(win=w, hop=w_ancho//4, fs=fs,fft_mode='onesided', mfft=16384, dual_win=None, scale_to=None, phase_shift=0)
Sx = SFT.stft(x)
...
ax.set_ylim(0, 7000)
ax.set_title('Espectrograma - Banda Angosta')
